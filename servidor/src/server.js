...
// const novoCurso = mongoose.model('cursos')

// novoCurso.exists({name:'iência da Computação'}, function (err, result) {
//   if (err){
//     console.log(err)
//   }else{
...
// const novoCurso = mongoose.model('cursos')
// novoCurso.countDocuments({codigo: 1, nome: 'Ciência da Computação'}, (count) => {
//   console.log(count);
// })
